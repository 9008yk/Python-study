...
- [x] Day 6：函数定义、参数、返回值
- [x] Day 7：综合小任务，做一个能保存文件的“待办清单”

## 完成标准

- 能不看资料写出变量、条件、循环、列表、字典、函数的示例
- 能读懂常见报错信息，比如 `NameError`、`TypeError`、`IndentationError`
- 能通过 `python 文件名.py` 运行自己的代码
